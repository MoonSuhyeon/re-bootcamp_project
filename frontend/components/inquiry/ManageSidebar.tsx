...
const NAV: SidebarItem[] = [
  ...
  },
  {
    ...
    expandable: true,
    children: [
      { label: '출금계좌 등록/삭제/순위변경',  href: '#' },
      { label: '계좌비밀번호 신규/변경',       href: '#' },
      { label: '바른조회 서비스 등록/해지',    href: '#' },
      { label: '자주쓰는계좌 등록/삭제',      href: '/banking/frequent-accounts' },
      { label: '단계이체 등록/삭제',          href: '#' },
      { label: '입금계좌 등록/삭제',          href: '#' },
      { label: '주식입금계좌 등록/삭제',       href: '#' },
    ],
  },
  {
    label: '인터넷 뱅킹관리',
