...
export const GNB_MENUS = [
  ...
  },
  {
    ...
    megaMenu: [
      ...
      {
        title: '자동이체',
        href: '/transfer/auto-service/manage',
        items: [
          { label: '자동이체내역 조회/해지/변경', href: '/transfer/auto-service/manage' },
          { label: '자동이체 등록', href: '/transfer/auto-service/register' },
          { label: '자동이체결과확인증', href: '#' },
        ],
      },
      {
        title: '에스크로 이체',
  ...
  },
  {
    ...
    megaMenu: [
      ...
      },
      {
        ...
        items: [
          { label: '펀드 상품/가입', href: '#' },
          { label: '펀드 입금/환매/조회', href: '#' },
          { label: '펀드 관리', href: '#' },
          { label: '연금저축펀드', href: '#' },
          { label: '펀드 투자정보', href: '#' },
          { label: '연금계좌 가져오기', href: '#' },
          { label: 'RIA 세제혜택 관련 유의사항 안내', href: '#' },
        ],
      },
      {
        title: '대출',
      ...
      },
      {
        ...
        href: '#',
        items: [
          { label: 'ISA 상품/가입', href: '#' },
          { label: 'ISA 조회/입금', href: '#' },
          { label: 'ISA 해지(일임형)', href: '#' },
          { label: 'ISA 관리', href: '#' },
          { label: 'ISA 가이드', href: '#' },
          { label: 'RIA 세제혜택 관련 유의사항 안내', href: '#' },
        ],
      ...
      },
      {
        ...
        href: '#',
        items: [
          { label: 'AXful골드뱅킹', href: '#' },
          { label: '골드바', href: '#' },
          { label: '실버바', href: '#' },
          { label: '기념주화/기념메달', href: '#' },
        ],
      },
      {
        title: '외화예금',
        href: '#',
        items: [
          { label: '외화예금상품/가입', href: '#' },
          { label: '외화예금 주가입금', href: '#' },
          { label: '외화예금 조회/해지', href: '#' },
          { label: '외화예금 금리안내', href: '#' },
        ],
      },
    ],
  },
...
type TabMenuColumn = { title: string; href: string; items: { label: string; href: string }[]; disabled?: boolean }
const PRODUCT_TAB_MENUS: Record<string, TabMenuColumn[]> = {
  '/products/deposit': [
    { title: '예금 상품/가입', href: '/products/deposit/list', items: [] },
    { title: '판매중지상품', href: '#', items: [
      { label: '일반 예금상품', href: '#' },
      { label: '지수연동예금', href: '#' },
    ]},
    { title: '예금 조회/해지', href: '/products/deposit/inquiry/new', items: [
    ...
    { title: '예금 관리', href: '/products/deposit/manage/convert', items: [
      ...
      { label: '만기해지방법 변경', href: '/products/deposit/manage/maturity-change' },
      { label: '예금잔액조회 통보', href: '#' },
      { label: '재형저축한도 변경', href: '#' },
      { label: '상품만기알림서비스 신청/해지', href: '#' },
      { label: '비대면 예적금 해지 제한', href: '#' },
    ]},
    { title: '예금 가이드', href: '#', items: [
      { label: '예금금리 안내', href: '#' },
      { label: '예금관련 수수료', href: '#' },
    ]},
  ],
  '/products/fund': [
    { title: '펀드 상품/가입', href: '#', items: [
      { label: '펀드검색', href: '#' },
      { label: '이달의 추천펀드', href: '#' },
    ...
    { title: '연금계좌 가져오기', href: '#', items: [
      { label: 'AXful연금저축펀드 계좌이체신규', href: '#' },
      { label: 'AXful연금저축펀드로 계좌이체신청', href: '#' },
      { label: '계좌이체 신청 조회', href: '#' },
    ]},
    { title: 'RIA 세제혜택 관련 유의사항 안내', href: '#', items: [] },
  ],
  '/products/loan': [
    ...
    { title: '대출관리', href: '/products/loan/manage/rate', items: [
      ...
      { label: '개인대출 활부금(이자) 납입방법 변경', href: '/products/loan/manage/payment-method' },
      { label: '리브간편대출 계좌숨김 해제', href: '#' },
    ]},
    { title: '대출 가이드', href: '/products/loan/guide/rate', items: [
    ...
    { title: '신용평가 및 여신심사 자료제출', href: '/products/loan/credit-eval/biz-plan', items: [
  ...
  '/products/trust': [
    { title: '신탁 상품', href: '#', items: [] },
    { title: '신탁 조회/입금/해지', href: '#', items: [
  ...
  '/products/insurance': [
    { title: '보험 조회', href: '#', items: [
      { label: '보험계약 조회', href: '#' },
      { label: '거래내역 조회', href: '#' },
      { label: '보험 해약환급금 조회', href: '#' },
    ]},
    { title: '노란우산', href: '#', items: [
      { label: '노란우산 안내', href: '#' },
      { label: '노란우산 조회', href: '#' },
    ]},
    { title: '보험 가이드', href: '#', items: [
      { label: '방카슈랑스란?', href: '#' },
      { label: 'AXful방카 가입안내', href: '#' },
  ...
  '/products/gold': [
    { title: 'AXful골드뱅킹', href: '#', items: [
      { label: 'AXful골드뱅킹 상품안내', href: '#' },
      { label: 'AXful골드투자통장 신규', href: '#' },
      { label: 'AXful골드투자통장 입금', href: '#' },
      { label: 'AXful골드투자통장 해지계좌조회', href: '#' },
      { label: 'AXful골드투자통장 출금', href: '#' },
      { label: '포인트 금(Gold)전환 서비스(포인트리 포함)', href: '#' },
      { label: '골드 가격조회 및 시장동향', href: '#' },
      { label: '골드뱅킹 계산기', href: '#' },
    ]},
    { title: '골드바', href: '#', items: [
      { label: '골드바 안내', href: '#' },
      { label: '골드바 가격조회', href: '#' },
      { label: '골드바 구매', href: '#' },
    ]},
    { title: '실버바', href: '#', items: [
      { label: '실버바 안내', href: '#' },
      { label: '실버바 가격조회', href: '#' },
      { label: '실버바 구매', href: '#' },
    ]},
    { title: '기념주화/기념메달', href: '#', items: [
      { label: '기념주화/기념메달 구매', href: '#' },
    ]},
  ],
  '/products/fx-deposit': [
    { title: '외화예금상품/가입', href: '#', items: [
      { label: '전체예금상품', href: '#' },
      { label: '판매중지상품', href: '#' },
    ]},
    { title: '외화예금 추가입금', href: '#', items: [] },
    { title: '외화예금 조회/해지', href: '#', items: [
      { label: '외화예금자산조회', href: '#' },
      { label: '신규결과조회', href: '#' },
      { label: '자동연장결과조회', href: '#' },
      { label: '외화예금해지', href: '#' },
                    ...
                    {category.items.length > 0 && (
                      <ul className="space-y-0.5">
                        {category.items.map((item) => {
                          const disabledItem = (item as { label: string; href: string; disabled?: boolean }).disabled
                          return (
                            <li key={item.href} className={`rounded transition-colors duration-100 ${disabledItem ? '' : 'hover:bg-[#e8f7f2]'}`}>
                              {disabledItem ? (
                                <span className="block text-[15px] px-4 py-2 text-kb-text-muted/50 cursor-default select-none">
                                  {item.label}
                                </span>
                              ) : (
                                <Link
        ...
        >
          <div className="max-w-kb-container mx-auto px-6">
            <ul className="flex w-full">
              {[
                { label: '예금',    href: '/products/deposit', tabKey: '/products/deposit' },
                { label: '펀드',    href: '#',                 tabKey: '/products/fund' },
                { label: '대출',    href: '/products/loan',    tabKey: '/products/loan' },
                { label: '신탁',    href: '#',                 tabKey: '/products/trust' },
                { label: 'ISA',     href: '#',                 tabKey: '/products/isa' },
                { label: '보험/공제', href: '#',               tabKey: '/products/insurance' },
                { label: '골드',    href: '#',                 tabKey: '/products/gold' },
                { label: '외화예금', href: '#',                tabKey: '/products/fx-deposit' },
              ].map(tab => {
                const isActive = tab.href !== '#' && pathname.startsWith(tab.href)
                return (
                  <li key={tab.label} className="flex-1" onMouseEnter={() => setActiveProductTab(tab.tabKey)}>
                    <Link
                      href={tab.href}
                ...
                <div className="grid grid-cols-5 gap-y-6">
                  {activeProductTabMenu.map((col, ci) => (
                    <div key={col.title} className={ci % 5 !== 0 ? 'border-l border-kb-border pl-6' : 'pr-6'}>
                      {col.disabled ? (
                        <span className="block text-[17px] font-bold text-kb-text-muted/50 mb-1 cursor-default select-none">
                          {col.title}
                        </span>
                      ) : (
                        <Link
