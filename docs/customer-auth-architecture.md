...
> **다이어그램**: Mermaid (GitHub·VSCode 미리보기에서 렌더링). 전체 시스템 개요는 [`../README.md`](../README.md)의 아키텍처 절 참조.
...
> 역할 권한 매트릭스 상세: [`decisions/admin-role-model.md`](decisions/admin-role-model.md) 참조.
